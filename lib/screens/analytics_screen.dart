    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          const Text('Total Library Searches', style: TextStyle(color: Colors.white60, fontSize: 13, fontWeight: FontWeight.w500)),
          const SizedBox(height: 4),
          const Text('14,208', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.w900)),
          const SizedBox(height: 24),
          const Divider(color: Colors.white12),
          const SizedBox(height: 24),
          const Text('Most Searched Category', style: TextStyle(color: Colors.white60, fontSize: 13, fontWeight: FontWeight.w500)),
          const SizedBox(height: 8),
          const Text('Legal Studies', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w800)),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Generated Ranking Table', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
              const Text('Showing data from Sept 5 - Sept 20, 2023', style: TextStyle(color: AppTheme.textGrey, fontSize: 12, fontWeight: FontWeight.w500)),
            ],
          ),
          const SizedBox(height: 32),
          // Table Header
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text(title, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 14, color: AppTheme.textDark)),
          ),
          Expanded(
            flex: 1,
            child: Text(author, style: const TextStyle(color: AppTheme.textGrey, fontSize: 13, fontWeight: FontWeight.w500)),
          ),
          SizedBox(
            width: 100,
